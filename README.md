...
METHODS :
Eksplorasi data
Menentukan metrics yang akan disajikan
Menentukan design visualisasi
Wrangling data menggunakan sql
Membuat user flow dan hi fi prototype
Membuat tableau dashboard
